...
public class MarioPequeno implements IMarioState {
    ...
    public IMarioState pegarCogumelo(){
        System.out.println("Mario ficou grande e ganhou 1000 pontos!");
        mario.ganharPontos(1000);
        return new MarioGrande(mario);
    }
    public IMarioState pegarFlor(){
        System.out.println("Mario ficou com fogo e ganhou 1000 pontos!");
        mario.ganharPontos(1000);
        return new MarioFogo(mario);
    }
    public IMarioState pegarPena(){       
        System.out.println("Mario ganhou capa e 1000 pontos!");
        mario.ganharPontos(1000);
        return new MarioCapa(mario);
    }
    public IMarioState levarDano(){
        System.out.println("Mario pequeno perdeu 1000 pontos!");
        mario.perderPontos(1000);
        return new MarioPequeno(mario);
    }
    
    public IEstado subir(Elevador e) {
        System.out.println("MarioPequeno esta subindo no elevador.");      
        return new EstadoSubindo();
    }

    public IEstado descer(Elevador e) {
        System.out.println("MarioPequeno esta descendo no elevador.");       
        return new EstadoDescendo();
    }
 
    public IEstado parar(Elevador e) {
        System.out.println("MarioPequeno parou o elevador parou.");    
